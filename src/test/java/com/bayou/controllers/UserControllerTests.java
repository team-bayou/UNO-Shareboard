...
public class UserControllerTests {
    ...
    public void setup() {
        ...
        String plainCreds = System.getenv("USERNAME")+":"+System.getenv("PASSWORD");
        ...
        ResponseEntity<Long> entity = rest.postForEntity(
                Server.url() + RESOURCE_URL + "/add", new HttpEntity<>(view, Server.createHeadersJson()), Long.class, headers);
    ...
    public void testGetUserById() {
        ...
        ResponseEntity<UserView> responseEntity = rest.getForEntity(
                Server.url() + RESOURCE_URL + "/" + view.getId(), UserView.class, headers);
    ...
    public void testGetUserByAccountName() {
        ...
        ResponseEntity<UserView> responseEntity = rest.getForEntity(
                Server.url() + RESOURCE_URL + "/accountName/" + view.getAccountName(), UserView.class,  headers);
    ...
    public void testGetUserByEmail() {
        // Get user by email.
        ResponseEntity<UserView> responseEntity = rest.getForEntity(
                Server.url() + RESOURCE_URL + "/email/" + view.getEmail(), UserView.class, headers);
    ...
    public void testAddUser() {
        ...
        // Delete test data.
        rest.delete(Server.url() + RESOURCE_URL + "/" + view.getId() + "/delete", String.class, headers);
    }
    ...
    public void testDeleteUser() {
        ...
        ResponseEntity responseEntity = rest.exchange(
                ...
                HttpMethod.DELETE, new HttpEntity<>(view, Server.createHeadersJson()), String.class,headers);
